...
if "tgt_start"        not in st.session_state: st.session_state.tgt_start        = date(2025, 1, 1)
if "tgt_end"          not in st.session_state: st.session_state.tgt_end          = date(2025, 12, 31)
